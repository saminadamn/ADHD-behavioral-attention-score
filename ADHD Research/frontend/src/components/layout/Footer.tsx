  ...
  return (
    <footer className="border-t border-border bg-surface mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <span className="font-bold text-white text-sm">BAS Research</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-slate-500">
              <p className="font-medium text-slate-400">Samina Parveen</p>
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                <a href="mailto:" className="text-slate-500 hover:text-white transition-colors">
        ...
        <div className="border-t border-border mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-600">
