...
import { Github, Mail, University, BookOpen, ExternalLink } from "lucide-react";

const DOMAINS = [
  { label: "AI for Health",                color: "#4A9FD8", icon: "🧬" },
  { label: "Natural Language Processing",  color: "#3CB48A", icon: "💬" },
  { label: "Educational Technology",       color: "#E891B0", icon: "🎓" },
  { label: "Neurodevelopmental Disorders", color: "#E8A020", icon: "🧠" },
  { label: "Reinforcement Learning",       color: "#E86060", icon: "🎮" },
  { label: "Multi-Agent Systems",          color: "#6DB8E8", icon: "🤖" },
];
  ...
  return (
    <div className="pt-24 pb-20 px-4 sm:px-6 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="w-20 h-20 mx-auto mb-5 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-3xl font-black text-white shadow-xl shadow-primary/20">
            SP
          </div>
          <h2 className="text-2xl font-bold text-slate-800">Samina Parveen</h2>
          <p className="text-slate-500 mt-1">B.Tech, Information Technology</p>
          ...
          <div className="mt-2 text-sm text-slate-500">
            ...
            <span className="font-semibold text-slate-700">Dr. Itu Snigdh</span>
            <span className="text-slate-400"> · Associate Professor, CSE</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 mt-5">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-border hover:border-primary/30 text-slate-500 hover:text-primary text-sm transition-all"
            >
        ...
        {/* Research domains */}
        <div className="mb-8">
          <h3 className="text-lg font-bold text-slate-800 mb-4">Research Domains</h3>
        ...
        {/* Technology stack */}
        <div className="mb-8">
          <h3 className="text-lg font-bold text-slate-800 mb-4">Full Technology Stack</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {STACK.map((s, i) => (
              <motion.div
                ...
                className="card"
              >
                <div className="text-xs font-semibold text-primary uppercase tracking-wider mb-3">{s.category}</div>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider">Abstract</h3>
          </div>
          <p className="text-slate-600 leading-relaxed text-sm">
            ...
            in real time. This work presents the <span className="text-slate-800 font-semibold">Behavioral Attention Score (BAS)</span>,
          ...
          <p className="text-slate-600 leading-relaxed text-sm mt-3">
            We implement a five-agent <span className="text-slate-800 font-semibold">LangGraph StateGraph</span> pipeline that
